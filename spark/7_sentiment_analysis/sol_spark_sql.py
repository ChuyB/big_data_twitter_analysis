...
# Limita la cantidad de registros (opcional para pruebas)
small_extract_query = """
SELECT *
...
# Une tokens con el léxico para asignar calificaciones
word_rating_query = """
SELECT 
    t.tweet_id, 
    t.tweet_content, 
...
# Agrupa las calificaciones por cada tweet y calcular el promedio
avg_rate_query = """
SELECT 
    tweet_id, 
    tweet_content, 
